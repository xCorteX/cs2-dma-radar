    ...
    public void run() {
        ...
        if (isKnowMap) {
            ...
            playerInfo = new PlayerInfo(
                    ...
                    playerZ,
                    90 - memoryTool.readFloat(Pawn + 0x1510 + 0x4, 8),
                    levelDv < levelHeight);
        } else {
            float angle = memoryTool.readFloat(LocalPlayerController + 0x1510 + 0x4, 8) - 90; 
            int teamId = memoryTool.readInt(EntityAddress + 0x3bf, 4);
            ...
            playerInfo = new PlayerInfo(
                    ...
                    newY,
                    playerZ,
                    90 - memoryTool.readFloat(Pawn + 0x1510 + 0x4, 8) + angle,
                    levelDv < levelHeight);
        }
    }
