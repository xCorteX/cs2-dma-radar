 ...
 * MemProcFS for Java requires JNA - https://github.com/java-native-access/jna
...
public interface IVmm {
     ...
     * 
     * @param vmmNativeLibraryPath path to vmm.dll / vmm.so native binaries, ex:
     ...
     * 
     * @param isBigPoolOnly true=only show entries from bigpool, false=show all
     *                      entries.
     * @return
     */
