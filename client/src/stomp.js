!(function (e, t) {
    ...
    class n {
        constructor(e) {
            ...
            ;(this.command = t),
                ...
                i ? ((this._binaryBody = i), (this.isBinaryBody = !0)) : ((this._body = n || ''), (this.isBinaryBody = !1)),
        ...
        serializeCmdAndHeaders() {
            ...
            return (
                (this.isBinaryBody || (!this.isBodyEmpty() && !this.skipContentLengthHeader)) && e.push(`content-length:${this.bodyLength()}`),
                e.join(t) + t + t
            )
        }
        isBodyEmpty() {
    ...
    class a {
        ...
        forceDisconnect() {
            this._webSocket &&
                ((this._webSocket.readyState !== e.StompSocketState.CONNECTING && this._webSocket.readyState !== e.StompSocketState.OPEN) ||
            ...
            'function' != typeof this._webSocket.terminate &&
                ...
                (e.terminate = function () {
                    ...
                    ;(this.onclose = (e) => {
                        ...
                        this.close(),
                        o?.call(e, { code: 4001, reason: `Quick discarding socket (#${i}) without waiting for the shutdown sequence.`, wasClean: !1 })
                })),
            ...
            ;(this._stompHandler = new a(this, t, {
                ...
                onConnect: (e) => {
                    if ((this._connectionWatcher && (clearTimeout(this._connectionWatcher), (this._connectionWatcher = void 0)), !this.active))
                        return this.debug('STOMP got connected while deactivate was issued, will disconnect now'), void this._disposeStompHandler()
                    this.onConnect(e)
                },
                onDisconnect: (e) => {
                    this.onDisconnect(e)
